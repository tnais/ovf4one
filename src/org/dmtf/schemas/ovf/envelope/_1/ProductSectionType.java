    ...
    extends SectionType
{
    ...
    public static class Property {
        ...
        protected List<PropertyConfigurationValueType> value;
        ...
        @XmlAttribute(name = "password", namespace = "http://schemas.dmtf.org/ovf/envelope/1")
         ...
         * 
         */
        public List<PropertyConfigurationValueType> getValue() {
            if (value == null) {
                value = new ArrayList<PropertyConfigurationValueType>();
            }
            return this.value;
        }
